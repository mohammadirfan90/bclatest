...
"[project]/src/app/customer/accounts/apply/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ApplyAccountPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"])('/accounts/apply', {
                method: 'POST',
                body: JSON.stringify({
                    accountType
                })
...
//# sourceMappingURL=_bd8b2f27._.js.map